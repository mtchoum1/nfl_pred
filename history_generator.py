...
def generate_prediction_history():
    ...
    with open('prediction_history.csv', 'w', newline='') as csvfile:
        ...
        for year in range(2022, 2025):
            ...
            weekly_schedule_url = f"https://site.api.espn.com/apis/site/v2/sports/football/nfl/scoreboard?limit=1000&dates={year}"
            ...
            # Save the final teams' stats to a CSV file
